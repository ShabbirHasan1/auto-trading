...
//         // let k_list = Vec::<(String, Vec<K>, Vec<K>, Vec<K>, Vec<K>, Vec<K>, f64)>::new();
...
//             let order = |a, b, c, d, e, f, g| me.borrow_mut().order(product, a, b, c, d, e, f, g);

//             let cancel = |a| me.borrow_mut().cancel(a);
